...
@XmlEnum
public enum ImpactType implements Serializable {
    
    @XmlEnumValue("admin")
    ADMIN("admin"), @XmlEnumValue("dos")
    DOS("dos"), @XmlEnumValue("file")
    FILE("file"), @XmlEnumValue("recon")
    RECON("recon"), @XmlEnumValue("user")
    USER("user"), @XmlEnumValue("other")
    OTHER("other");
