...
/**
 * <p>
 * Java class for additionaldata-type.
 * 
 * <p>
...
public enum AdditionaldataType implements Serializable {
    ...
    BOOLEAN("boolean"), @XmlEnumValue("byte")
    BYTE("byte"), @XmlEnumValue("character")
    CHARACTER("character"), @XmlEnumValue("date-time")
    DATE_TIME("date-time"), @XmlEnumValue("integer")
    INTEGER("integer"), @XmlEnumValue("ntpstamp")
    NTPSTAMP("ntpstamp"), @XmlEnumValue("portlist")
    PORTLIST("portlist"), @XmlEnumValue("real")
    REAL("real"), @XmlEnumValue("string")
    STRING("string"), @XmlEnumValue("byte-string")
    BYTE_STRING("byte-string"), @XmlEnumValue("xml")
    XML("xml");
